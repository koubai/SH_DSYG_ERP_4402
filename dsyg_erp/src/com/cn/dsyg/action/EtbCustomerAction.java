 ...
 * @version 1.0
 */
public class EtbCustomerAction extends BaseAction {
	 ...
	 * 客户列表
	 */
	private List<EtbCustomerDto> listCustomer;
	 ...
	 * 新增客户对象
	 */
	private EtbCustomerDto addCustomerDto;
	 ...
	 * 修改客户对象
	 */
	private EtbCustomerDto updateCustomerDto;
	...
	private List<EtbCustomerDto> customerList;
	...
	public String showEtbCustomerAction() {
		try {
			...
			strCustomerNoHigh = "";
			strCustomerName = "";
			addCustomerDto = new EtbCustomerDto();
			updateCustomerDto = new EtbCustomerDto();
			updateCustomerNo = "";
			delCustomerNo = "";
			page = new Page();
			startIndex = 0;
			listCustomer = new ArrayList<EtbCustomerDto>();
		} catch(Exception e) {
			return ERROR;
		}
		return SUCCESS;
	...
	private void queryEtbCustomer() {
		...
		listCustomer = (List<EtbCustomerDto>) page.getItems();
	...
	public String addEtbCustomerAction() {
		try {
			...
			//校验客户代码是否存在
			EtbCustomerDto customer = customerService.queryAllEtbCustomerByID(addCustomerDto.getId()+"");
			if(customer != null) {
	 ...
	 * @return
	 */
	private boolean checkData(EtbCustomerDto customer) {
		if(customer == null) {
	...
	public List<EtbCustomerDto> getListCustomer() {
		return listCustomer;
	}

	public void setListCustomer(List<EtbCustomerDto> listCustomer) {
	...
	public EtbCustomerDto getAddCustomerDto() {
		return addCustomerDto;
	}

	public void setAddCustomerDto(EtbCustomerDto addCustomerDto) {
		this.addCustomerDto = addCustomerDto;
	}

	public EtbCustomerDto getUpdateCustomerDto() {
		return updateCustomerDto;
	}

	public void setUpdateCustomerDto(EtbCustomerDto updateCustomerDto) {
	...
	public List<EtbCustomerDto> getCustomerList() {
		return customerList;
	}

	public void setCustomerList(List<EtbCustomerDto> customerList) {
