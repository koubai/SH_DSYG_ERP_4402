 ...
 * @version 1.0
 */
public class EtbDocumentAction extends BaseAction {

	private static final long serialVersionUID = -99617567714090925L;

	private static final Logger log = LogManager.getLogger(EtbDocumentAction.class);
	 ...
	 * 文件物品列表
	 */
	private List<EtbDocumentDto> listDocument;
	 ...
	 * 新增文件物品对象
	 */
	private EtbDocumentDto addDocumentDto;
	 ...
	 * 修改文件物品对象
	 */
	private EtbDocumentDto updateDocumentDto;
	...
	private List<EtbDocumentDto> documentList;
	...
	public String showEtbDocumentAction() {
		try {
			...
			strDocumentNoHigh = "";
			strDocumentName = "";
			addDocumentDto = new EtbDocumentDto();
			updateDocumentDto = new EtbDocumentDto();
			updateDocumentNo = "";
			delDocumentNo = "";
			page = new Page();
			startIndex = 0;
			listDocument = new ArrayList<EtbDocumentDto>();
		} catch(Exception e) {
			return ERROR;
		}
		return SUCCESS;
	...
	private void queryEtbDocument() {
		...
		listDocument = (List<EtbDocumentDto>) page.getItems();
	...
	public String addEtbDocumentAction() {
		try {
			...
			//校验文件编号是否存在
			EtbDocumentDto document = documentService.queryAllEtbDocumentByID(addDocumentDto.getDocumentno()+"");
			if(document != null) {
	 ...
	 * @return
	 */
	private boolean checkData(EtbDocumentDto document) {
		if(document == null) {
	...
	public List<EtbDocumentDto> getListDocument() {
		return listDocument;
	}

	public void setListDocument(List<EtbDocumentDto> listDocument) {
	...
	public EtbDocumentDto getAddDocumentDto() {
		return addDocumentDto;
	}

	public void setAddDocumentDto(EtbDocumentDto addDocumentDto) {
		this.addDocumentDto = addDocumentDto;
	}

	public EtbDocumentDto getUpdateDocumentDto() {
		return updateDocumentDto;
	}

	public void setUpdateDocumentDto(EtbDocumentDto updateDocumentDto) {
	...
	public List<EtbDocumentDto> getDocumentList() {
		return documentList;
	}

	public void setDocumentList(List<EtbDocumentDto> documentList) {
