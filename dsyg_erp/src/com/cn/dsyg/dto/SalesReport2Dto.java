 ...
 * @version 1.0
 */
public class SalesReport2Dto extends BaseDto {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7419437397982259674L;
	...
	public void setSalesreportno(String salesreportno) {
		this.salesreportno = salesreportno;
	}

	public String getSalesreportname() {
		return salesreportname;
	}

	public void setSalesreportname(String salesreportname) {
		this.salesreportname = salesreportname;
	}
