 ...
 * @version 1.0
 */
public class RequestCashDto extends BaseDto {


	private static final long serialVersionUID = -7168867067709506358L;
	...
	public String getRequestcashno() {
		return requestcashno;
	}

	public void setRequestcashno(String requestcashno) {
		this.requestcashno = requestcashno;
	}

	public String getRequestcashname() {
		return requestcashname;
	}

	public void setRequestcashname(String requestcashname) {
		this.requestcashname = requestcashname;
	}
