...
<script type="text/javascript">
	...
	function addSupplier() {
		...
		var suppliername = inputs[1].value;
		var suppliermanageraddr = inputs[2].value;
		var suppliermanager = inputs[3].value;
		var suppliertel = inputs[4].value;
	...
	function queryList() {
		...
		document.mainform.action = '../supplier/turnSelectSupplierAction.action';
	...
	function changepagesize(pagesize) {
		...
		$("#selectStartIndex").attr("value", "0");
		document.mainform.action = '../supplier/querySelectSupplierAction.action';
		document.mainform.submit();
	}
		...
		<div class="searchbox">
			<div class="box1">
				...
				<div class="box1_center">
					<s:textfield name="strSelectSupplierName" id="strSelectSupplierName" cssStyle="width:120px;" maxlength="32" theme="simple"></s:textfield>
				</div>
		...
		<div class="data_table" style="padding:0px;">
			...
			<div class="tab_content">
				<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
					...
					<s:iterator id="listSelectSupplier" value="listSelectSupplier" status="st1">
						...
						<s:else>
							...
							<td style="display: none;">
								...
								<input type="hidden" value="<s:property value="supplieraddress1"/>"/>
								<input type="hidden" value="<s:property value="suppliermanager1"/>"/>
								<input type="hidden" value="<s:property value="suppliertel1"/>"/>
								<input type="hidden" value="<s:property value="supplierfax1"/>"/>
								<input type="hidden" value="<s:property value="suppliermail1"/>"/>
							</td>
				...
				<tr>
					<td>
						<div class="btn">
							<div class="box1_left"></div>
							<div class="box1_center">
								<input type="button" class="input80" value="确定" onclick="addSupplier();"/>
							</div>
							<div class="box1_right"></div>
						</div>
						<div class="btn">
