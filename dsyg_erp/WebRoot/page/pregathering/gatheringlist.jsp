		...
		<div class="content">
			...
			<s:form id="mainform" name="mainform" method="POST">
				...
				<div class="searchbox update">
					<div class="box1">
						<label class="pdf10" style="width:120px">预收款编号检索 FROM</label>
						<div class="box1_left"></div>
						<div class="box1_center">
							<s:textfield name="strPregatheringNoLow" id="strPregatheringNoLow" cssStyle="width:135px;" maxlength="4" theme="simple"></s:textfield>
						</div>
						<div class="box1_right"></div>
						<label>TO</label>
						<div class="box1_left"></div>
						<div class="box1_center">
							<s:textfield name="strPregatheringNoHigh" id="strPregatheringNoHigh" cssStyle="width:135px;" maxlength="4" theme="simple"></s:textfield>
						</div>
						<div class="box1_right"></div>
					</div>
				</div>
				<div class="searchbox update">
					<div class="box1" >
						<label class="pdf10" style="width:120px">到款名称</label>
						<div class="box1_left"></div>
						<div class="box1_center">
							<s:textfield name="strPregatheringName" id="strPregatheringName" cssStyle="width:135px;" maxlength="4" theme="simple"></s:textfield>
						</div>
						<div class="box1_right"></div>
					</div>
					<div class="box1" >
								...
								<s:else>
									...
									<td>
										<div noWrap style="text-overflow:ellipsis;overflow:hidden">
											<s:property value="pregatheringname"/>
										</div>
									</td>
