					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
						...
						<tr>
							...
							<td colspan="3">
								...
								<div class="box1_center">
									<s:textfield name="addSalesDto.salesno" id="salesno" disabled="true" cssStyle="width:300px;" maxlength="8" theme="simple"></s:textfield>
								</div>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="addSalesDto.handler" id="handler" cssStyle="width:300px;" maxlength="16" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<input type="text" id="tmpAmount" disabled="disabled" style="width:300px;" value="<s:property value="addSalesDto.amount"/>"/>
								</div>
								<div class="box1_right"></div>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<input type="text" id="tmpTaxamount" disabled="disabled" style="width:300px;" value="<s:property value="addSalesDto.taxamount"/>"/>
								</div>
								<div class="box1_right"></div>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<input type="text" id="tmpPaidamount" disabled="disabled" style="width:300px;" value="<s:property value="addSalesDto.paidamount"/>"/>
								</div>
								<div class="box1_right"></div>
								<div style="margin-top: 9px;"><label>（含税）</label></div>
							</td>
