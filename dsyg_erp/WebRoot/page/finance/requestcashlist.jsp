...
<script type="text/javascript">
	...
	function add() {
		document.mainform.action = '<c:url value="/finance/showAddRequestCashAction.action"></c:url>';
	...
	function upd() {
		...
		if(id == "") {
			...
			document.mainform.action = '<c:url value="/finance/showUpdRequestCashAction.action"></c:url>' + "?updateRequestCashNo=" + id;
			document.mainform.submit();
		}
	}
	...
	function del() {
		...
		if(id == "") {
			...
			if(confirm("确定删除该记录吗？")) {
				document.mainform.action = '<c:url value="/finance/delRequestCashAction.action"></c:url>' + "?delRequestCashNo=" + id;
				document.mainform.submit();
			}
		}
	}
	...
	function exportExcel() {
		document.mainform.action = '<c:url value="/finance/exportRequestCashAction.action"></c:url>';
		document.mainform.submit();
	}
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '<c:url value="/finance/turnRequestCashPage.action"></c:url>';
		document.mainform.submit();
	}
	...
	function changepagesize(pagesize) {
		...
		document.mainform.action = '../finance/queryRequestCashList.action';
		document.mainform.submit();
	}
		...
		<div class="content">
			...
			<s:form id="mainform" name="mainform" method="POST">
				...
				<div class="searchbox update">
					<div class="box1">
						<label class="pdf10" style="width:120px">请款编号检索 FROM</label>
				...
				<div class="searchbox update">
					<div class="box1" >
						<label class="pdf10" style="width:120px">请款内容</label>
						<div class="box1_left"></div>
						<div class="box1_center">
