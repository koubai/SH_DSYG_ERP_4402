...
<script type="text/javascript">
	function add() {
		var id = $("#requestcashno").val().trim();
		var salesreportname = $("#requestcashname").val().trim();
		...
		$("#reregisterdate").attr("value", tmpregisterdate);
		...
		document.mainform.action = '<c:url value="/finance/addRequestCashAction.action"></c:url>';
...
<s:form id="mainform" name="mainform" method="POST" enctype="multipart/form-data">
	<s:hidden name="addRequestCashDto.note" id="note"></s:hidden>
	<s:hidden name="addRequestCash.registerdate" id="registerdate"></s:hidden>
	...
	<s:hidden name="addRequestCashDto.requestcashno" id="requestcashno"></s:hidden>
	<div id="container" style="width: 100%; height: 100%;">
		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			<tr>
				<td><label class="pdf10"><font color="red">*</font>请款内容名</label></td>
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addRequestCashDto.requestcashname" id="requestcashname" cssStyle="width:350px;" maxlength="64" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				<td><label class="pdf10">请款人</label></td>
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addRequestCashDto.handler" id="handler" cssStyle="width:350px;" maxlength="32" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				<td><label class="pdf10">请款金额</label></td>
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addRequestCashDto.amount" id="amount" cssStyle="width:350px;" maxlength="64" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				<td><label class="pdf10"><font color="red">*</font>请款日期</label></td>
				<td>
					<div class="box1_left"></div>
					<div class="box1_center date_input">
						<input type="text" disabled="disabled" style="width: 100px;" id="tmpregisterdate" value="<s:property value="addRequestCashDto.showregisterdate"/>" maxlength="10" />
			...
			<tr>
				...
				<td>
					<textarea name="" id="tmpnote" cols="" rows="5" style="width:350px;"><s:property value="addRequestCashDto.note"/></textarea>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
