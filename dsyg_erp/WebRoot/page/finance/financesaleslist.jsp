...
<script type="text/javascript">
	...
	function upd(id, status) {
		document.mainform.action = "../finance/updFinanceSalesStatusAction.action?updSalesId=" + id + "&updSalesStatus=" + status;
	...
	function queryList() {
		setQueryDate();
		document.mainform.action = '../finance/queryFinanceSalesAction.action';
		document.mainform.submit();
	}
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '../finance/turnFinanceSalesAction.action';
		document.mainform.submit();
	}
						...
						<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
							...
							<s:iterator id="salesList" value="salesList" status="st1">
								...
								<s:else>
									...
									<td><s:property value="salesno"/></td>
									<td>
