...
<script type="text/javascript">
	...
	function add() {
		document.mainform.action = "../warehouse/showAddWarehouseRefundAction.action";
	...
	function upd() {
		...
		if(id == "") {
			...
			document.mainform.action = "../warehouse/showUpdWarehouseRefundAction.action?updWarehouseid=" + id;
			document.mainform.submit();
		}
	}
	...
	//查询数据
	function queryList() {
		document.mainform.action = '../warehouse/queryWarehouseRefundAction.action';
		document.mainform.submit();
	}
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '../warehouse/turmWarehouseRefundAction.action';
		document.mainform.submit();
	}
						...
						<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
							...
							<s:iterator id="warehouseList" value="warehouseList" status="st1">
								...
								<s:else>
									...
									<td>
										<s:if test='%{warehouseList[#st1.index].packaging == "0"}'>整箱</s:if>
										<s:elseif test='%{warehouseList[#st1.index].packaging == "1"}'>乱尺</s:elseif>
