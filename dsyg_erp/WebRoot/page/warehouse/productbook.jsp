	...
	<div id="container" style="width: 100%; height: 100%;">
		<div class="data_table" style="padding:0px;">
			...
			<div class="tab_content" style="height: 300px;"><BR>
				品名:<s:property value="warehouseOkList[0].tradename"/>&nbsp&nbsp&nbsp规格:<s:property value="warehouseOkList[0].typeno"/>&nbsp&nbsp&nbsp颜色:<s:iterator id="colorList" value="colorList" status="st3"><s:if test="%{colorList[#st3.index].code == warehouseOkList[0].color}"><s:property value="fieldname"/></s:if></s:iterator>&nbsp&nbsp&nbsp包装:<s:if test='warehouseOkList[0].packaging.equals("0")'>整箱</s:if><s:elseif test='warehouseOkList[0].packaging.equals("1")'>乱尺</s:elseif><s:else>乱尺</s:else>			
