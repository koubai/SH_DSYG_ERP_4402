								...
								<s:else>
									...
									<td>
										<s:iterator id="goodsList" value="goodsList" status="st3">
											<s:if test="%{goodsList[#st3.index].code == warehouseInOkList[#st1.index].theme1}">
									...
									<td>
										<s:if test='%{warehouseInOkList[#st1.index].packaging == "1"}'>整箱</s:if>
										<s:elseif test='%{warehouseInOkList[#st1.index].packaging == "0"}'>乱尺</s:elseif>
										<s:else>
