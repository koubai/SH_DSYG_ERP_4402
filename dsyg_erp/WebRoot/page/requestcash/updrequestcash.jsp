...
<script type="text/javascript">
	function upd() {
		...
		document.mainform.action = '<c:url value="/requestcash/updRequestCashAction.action"></c:url>';
			...
			<tr>
				...
				<td>
					...
					<div class="box1_center">
						<s:textfield name="updateRequestCashDto.requestcashname" id="requestcashname" cssStyle="width:350px;" maxlength="40" theme="simple"></s:textfield>
					</div>
