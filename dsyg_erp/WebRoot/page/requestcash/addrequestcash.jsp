...
<script type="text/javascript">
	function add() {
		...
		document.mainform.action = '<c:url value="/requestcash/addRequestCashAction.action"></c:url>';
...
<s:form id="mainform" name="mainform" method="POST" enctype="multipart/form-data">
	...
	<s:hidden name="addRequestCashDto.registerdate" id="registerdate"></s:hidden>
	...
	<div id="container" style="width: 100%; height: 100%;">
		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			...
			<tr>
				<td><label class="pdf10">金额</label></td>
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
