					...
					<s:iterator id="productList" value="productList" status="st1">
						...
						<s:else>
							...
							<td style="display: none;">
								...
								<input type="hidden" value="<s:if test='%{productList[#st1.index].packaging == "0"}'>整箱</s:if><s:elseif test='%{productList[#st1.index].packaging == "1"}'>乱尺</s:elseif><s:elseif test='%{productList[#st1.index].packaging == "2"}'>样品</s:elseif><s:else>乱尺</s:else>"/>
