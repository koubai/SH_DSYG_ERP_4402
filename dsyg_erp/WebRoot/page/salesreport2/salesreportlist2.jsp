...
<script type="text/javascript">
	...
	function del() {
		...
		if(id == "") {
			...
			if(confirm("确定删除该记录吗？")) {
				document.mainform.action = '<c:url value="/salesreport/delSalesReport2Action.action"></c:url>' + "?delSalesReportNo=" + id;
				document.mainform.submit();
			}
		}
	}
				...
				<div class="data_table" style="padding:0px;">
					...
					<div class="tab_content" style="height: <s:property value="intPageSize * 35"/>px;">
						<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
							...
							<s:iterator id="listSalesReport2" value="listSalesReport2" status="st1">
