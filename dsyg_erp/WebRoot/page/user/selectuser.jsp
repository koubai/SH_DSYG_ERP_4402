...
<script type="text/javascript">
	...
	function queryList() {
		...
		document.mainform.action = '../user/turnSelectUserAction.action';
	...
	function changepagesize(pagesize) {
		...
		$("#selectStartIndex").attr("value", "0");
		document.mainform.action = '../user/querySelectUserAction.action';
		document.mainform.submit();
	}
		...
		<div class="searchbox">
			<div class="box1">
				...
				<div class="box1_center">
					<s:textfield name="strSelectUserName" id="strSelectUserName" cssStyle="width:120px;" maxlength="32" theme="simple"></s:textfield>
				</div>
		...
		<div class="data_table" style="padding:0px;">
			...
			<div class="tab_content">
				<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
					...
					<s:iterator id="listSelectUser" value="listSelectUser" status="st1">
						...
						<s:else>
							...
							<td>
								<div noWrap style="width:250px;text-overflow:ellipsis;overflow:hidden">
				...
				<tr>
					<td>
						<div class="btn">
							<div class="box1_left"></div>
							<div class="box1_center">
								<input type="button" class="input80" value="确定" onclick="addUser();"/>
							</div>
							<div class="box1_right"></div>
						</div>
						<div class="btn">
